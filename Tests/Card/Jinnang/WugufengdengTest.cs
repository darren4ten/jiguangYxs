...
{
    [TestFixture]
    public class WugufengdengTest
    {
        [Test]
        public async Task WugufengdengTest_Success()
        {
            ...
            player2.Init();
            player3.Init();
            var cardToPlay = new Wugufengdeng().AttachPlayerContext(new PlayerContext() { Player = player1, GameLevel = gameLevel1 });
            ...
            Assert.AreEqual(3, player3.CardsInHand.Count);
        }
    }
}
