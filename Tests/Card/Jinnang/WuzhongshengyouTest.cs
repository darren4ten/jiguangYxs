...
{
    [TestFixture]
    public class WuzhongshengyouTest
    {
        [Test]
        public async Task TestWuzhongshengyou_Success()
        {
            ...
            var cardToPlay = new Wuzhongshengyou().AttachPlayerContext(new PlayerContext() { Player = player1, GameLevel = gameLevel1 });
